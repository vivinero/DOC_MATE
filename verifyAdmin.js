const generateDynamicEmail=( link,hospitalName)=> {
                    ...
                    <tr>
                        <td>
                            <div style="padding: 0 2.5em; text-align: center;">
                                ...
                                <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome On Board , ${hospitalName},<br/>Click the button below to verify your account as an admin.</h3>
                                <p><a href=${link} class="btn btn-primary" style="padding: 15px 35px; display: inline-block; border-radius: 3px; background: #2C7DA0; color: #ffffff; text-decoration: none;">Verify</a></p>
